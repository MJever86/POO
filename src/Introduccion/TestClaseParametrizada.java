...
public class TestClaseParametrizada {
	...
	public static void main(String[] args) {
		...
		ClaseParametrizada<Integer> c1= new ClaseParametrizada<>();
		for (int i : numeros) {
			c1.addElemento(i);
		}
		System.out.println(c1);
		String []cadenas= {"hola","mundo","ddd"};
		ClaseParametrizada<String> c2=new ClaseParametrizada<>();
		...
		c3.addElemento(u1);
		Usuario u2= new Usuario("juan", "passwordJuan");
		c3.addElemento(u2);
		Usuario u3= new Usuario("juan", "passwordJuan");
		c3.addElemento(u3);
